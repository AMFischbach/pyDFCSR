...
def interpolate3D(translated_points, data_list, step_size, result):      
    ...
    for point_index in range(len(translated_points)):
        ...
        out_of_bounds_left = ((cl0_index_small >= 0) and (cl1_index_small >= 0) and (cl0_index_large < obins) and (cl1_index_large < pbins))
        out_of_bounds_right = ((cr0_index_small >= 0) and (cr1_index_small >= 0) and (cr0_index_large < obins) and (cr1_index_large < pbins))
