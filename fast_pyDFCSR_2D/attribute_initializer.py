...
def init_attributes(input_dict = {}):
    ...
    df_tracker = DF_Tracker(lattice.total_steps, histo_mesh_params, csr_mesh_params)

    statistics = init_stats(lattice.total_steps)

    return statistics, integration_params, csr_mesh_params, lattice, beam, df_tracker
